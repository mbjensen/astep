...
import dk.aau.astep.appserver.business.service.indoor.AllClient.Locations;
import dk.aau.astep.appserver.business.service.indoor.AllClient.AllClient;
import dk.aau.astep.appserver.business.service.indoor.SingleClient.WirelessClientLocation;
import dk.aau.astep.appserver.business.service.indoor.SingleClient.Client;
...
public class staticMethodsTest {
    ...
    static public void setUp() throws Exception {
        ...
        try {
            localServer = HttpServer.create(new InetSocketAddress(localIP, 8080), 1);
        } catch (IOException e) {
            e.printStackTrace();
        }
