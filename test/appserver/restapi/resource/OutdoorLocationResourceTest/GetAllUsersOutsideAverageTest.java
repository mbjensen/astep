 ...
 */
public class GetAllUsersOutsideAverageTest {
    ...
    public void testCorrectData() {
        Response response = target.path("locations/outdoor/users/"+usernames+"/outsideaverage")
                .request().header(token_string, token).get();
